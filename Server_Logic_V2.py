#--- Avoid body collisions and go to nearest food
...
def path_to_food(my_head, food, possible_moves):
  ...
  elif len(food)-1>food[Dist_to_food[k][1]:
    k+=1
    print("2")
...
def avoid_my_neck(my_head: Dict[str, int], my_body: List[dict], possible_moves: List[str], board_height, board_width, enemy_body) -> List[str]:
...
def choose_move(data: dict) -> str:
    ...
    possible_moves = avoid_my_neck(my_head, my_body, possible_moves, data["board"]["height"], data["board"]["width"], snakes[0]["body"])
